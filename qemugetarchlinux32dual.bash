...
LATESTI686="$(grep dual sha512sums |tail -n 1)"
printf "%s\\n\\n" "Found filename '${LATESTI686##* }' with sha512sum ${LATESTI686%% *}."
[ -f "${LATESTI686##* }" ] && printf "%s\\n\\n" "Found filename '${LATESTI686##* }'." || curl -C - --fail --retry 4 -OL "https://mirror.math.princeton.edu/pub/archlinux32/archisos/${LATESTI686##* }"
